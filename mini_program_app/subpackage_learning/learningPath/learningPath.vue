...
<style scoped>
.learning-page{min-height:100vh;padding:24rpx 24rpx 80rpx;background:#f5f7fb;box-sizing:border-box;color:#172033}.state-card{padding:80rpx 34rpx;border-radius:24rpx;background:#fff;text-align:center}.state-card__title,.state-card__desc{display:block}.state-card__title{font-size:32rpx;font-weight:760}.state-card__desc{margin-top:14rpx;color:#64748b;font-size:25rpx;line-height:1.6}.state-card button{margin-top:26rpx;border:0;background:#4f46e5;color:#fff}.path-summary{padding:32rpx;border-radius:26rpx;background:linear-gradient(145deg,#fff,#eef2ff);box-shadow:0 12rpx 36rpx rgba(79,70,229,.08)}.path-summary__eyebrow,.path-summary__title,.path-summary__status,.path-summary__desc{display:block}.path-summary__eyebrow{color:#6366f1;font-size:20rpx;font-weight:750;letter-spacing:2rpx}.path-summary__title{margin-top:12rpx;font-size:36rpx;font-weight:800}.path-summary__status{display:inline-block;margin-top:14rpx;padding:8rpx 14rpx;border-radius:999rpx;background:#dcfce7;color:#166534;font-size:21rpx}.path-summary__desc{margin-top:18rpx;color:#64748b;font-size:24rpx;line-height:1.65}.path-summary__replan{margin-top:24rpx;border:0;border-radius:15rpx;background:#4f46e5;color:#fff;font-size:25rpx}.timeline{margin-top:28rpx}.path-item{display:flex;align-items:stretch;gap:18rpx}.path-item__rail{display:flex;width:56rpx;flex-direction:column;align-items:center}.path-item__index{width:52rpx;height:52rpx;border-radius:18rpx;background:#e0e7ff;color:#4338ca;text-align:center;line-height:52rpx;font-weight:750}.path-item--completed .path-item__index,.path-item--done .path-item__index{background:#dcfce7;color:#166534}.path-item__line{flex:1;width:4rpx;min-height:36rpx;background:#dbe2ea}.path-item__card{flex:1;margin-bottom:20rpx;padding:26rpx;border-radius:22rpx;background:#fff}.path-item__head{display:flex;justify-content:space-between;gap:16rpx}.path-item__topic{font-size:29rpx;font-weight:740}.path-item__status{flex-shrink:0;color:#6366f1;font-size:21rpx}.path-item__objective,.path-item__reason{display:block;margin-top:12rpx;color:#64748b;font-size:23rpx;line-height:1.6}.path-item__reason{padding:14rpx;border-radius:12rpx;background:#f8fafc}.path-item__tags{display:flex;flex-wrap:wrap;gap:9rpx;margin-top:14rpx}.path-item__tags text{padding:7rpx 12rpx;border-radius:999rpx;background:#eef2ff;color:#4338ca;font-size:20rpx}.path-item__actions{display:flex;gap:12rpx;margin-top:20rpx}.path-item__action{flex:1;margin:0;border:0;border-radius:13rpx;background:#4f46e5;color:#fff;font-size:23rpx}.path-item__action--secondary{background:#eef2ff;color:#4338ca}
</style>
