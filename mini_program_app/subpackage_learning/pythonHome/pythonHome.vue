...
.hero {
  ...
  color: #fff;
  box-shadow: 0 16rpx 44rpx rgba(74, 144, 217, 0.22);
}
.hero__eyebrow,
.hero__title,
.hero__desc,
...
.state-card__button {
  ...
  color: #fff;
  font-size: 26rpx;
  box-shadow: 0 6rpx 20rpx rgba(74, 144, 217, 0.28);
}
...
.action-card__graph-icon {
  position: relative;
  width: 52rpx;
  height: 34rpx;
}
.action-card__graph-icon view {
  position: absolute;
  width: 12rpx;
  height: 12rpx;
...
.action-card__graph-icon view:nth-child(1) {
  left: 0;
  top: 11rpx;
}
.action-card__graph-icon view:nth-child(2) {
  left: 20rpx;
  top: 0;
}
.action-card__graph-icon view:nth-child(3) {
  right: 0;
  bottom: 0;
}
.action-card__graph-icon:before,
.action-card__graph-icon:after {
  content: '';
  position: absolute;
  left: 10rpx;
  width: 30rpx;
