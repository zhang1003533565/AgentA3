    ...
    <view v-else-if="course" class="course-content">
      <view class="book-hero">
        ...
        <view class="book-copy">
          ...
          <text class="owner">{{ course.ownerName || '课程管理员' }}</text>
        </view>
      </view>
