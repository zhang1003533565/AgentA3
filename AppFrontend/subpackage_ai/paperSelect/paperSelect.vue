...
.page{min-height:100vh;background:#f5f8fc;padding-bottom:110rpx}.summary{margin:18rpx 24rpx;padding:24rpx;background:#fff;border-radius:18rpx;display:flex;justify-content:space-between}.paper-name{display:block;font-weight:700}.paper-meta,.bank-desc,.knowledge{display:block;color:#929dad;font-size:22rpx;margin-top:8rpx}.selected-link{color:#4775e5}.filters{display:flex;gap:12rpx;padding:18rpx 24rpx}.search{flex:1;background:#fff;border-radius:30rpx;padding:14rpx 20rpx}.chip{background:#fff;border-radius:28rpx;padding:14rpx 20rpx}.list{height:calc(100vh - 280rpx);padding:0 24rpx;box-sizing:border-box}.bank-card,.question-card{background:#fff;border-radius:18rpx;padding:24rpx;margin-bottom:14rpx}.bank-card{display:flex;justify-content:space-between;align-items:center}.bank-name{display:block;font-weight:600}.bank-count{color:#4775e5}.tags text{background:#edf3ff;color:#5876bc;padding:6rpx 12rpx;border-radius:10rpx;font-size:20rpx;margin-right:8rpx}.content{display:block;margin:18rpx 0;line-height:1.6}.actions{display:flex;justify-content:space-between;align-items:center;color:#e2a034}.actions button{margin:0;background:#4d78e8;color:#fff;border-radius:30rpx;font-size:23rpx}.actions .added{background:#eaf0fc;color:#7790c6}.chosen{border:2rpx solid #82a4fa}.empty{text-align:center;color:#9ba6b7;padding:100rpx 0}.bottom{position:fixed;left:0;right:0;bottom:0;background:#fff;padding:16rpx 24rpx;display:flex;justify-content:space-between;align-items:center}.bottom button{margin:0;background:#4d78e8;color:#fff;border-radius:32rpx;font-size:24rpx}
