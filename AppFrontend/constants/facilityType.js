...
export const FACILITY_TYPES = [
  { value: 1, label: '食堂', mapCategory: 3, typeClass: 'canteen', icon: '🍚', poiEmoji: '🍽️', serviceHint: '今日菜单', detailPath: '/subpackage_facility/restaurantDetail/restaurantDetail' },
  { value: 2, label: '运动场', mapCategory: 5, typeClass: 'sport', icon: '🏟', poiEmoji: '🏟', secondaryLabel: '场地预约', serviceHint: '在线预约', detailPath: '/subpackage_sports/sportsDetail/sportsDetail' },
  ...
  { value: 4, label: '综合服务', mapCategory: 4, typeClass: 'dorm', icon: '🏠', poiEmoji: '🏠', detailPath: '/subpackage_dormitory/dormitoryDetail/dormitoryDetail' },
  { value: 5, label: '校内商铺', mapCategory: 4, typeClass: 'shop', icon: '🏪', poiEmoji: '🛍️' },
  { value: FACILITY_TYPE_OTHER, label: '其他', mapCategory: 4, typeClass: 'admin', icon: '📍', poiEmoji: '📍' },
]
