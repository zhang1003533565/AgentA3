...
DELETE FROM system_config WHERE config_key IN (
  ...
  'ai.service.text.provider', 'ai.service.text.base-url', 'ai.service.text.api-key', 'ai.service.text.model',
  'ai.service.image.provider', 'ai.service.image.base-url', 'ai.service.image.api-key', 'ai.service.image.model',
  'ai.service.video.provider', 'ai.service.video.base-url', 'ai.service.video.api-key', 'ai.service.video.model',
  'ai.service.audio.provider', 'ai.service.audio.base-url', 'ai.service.audio.api-key', 'ai.service.audio.model'
);
...
(22, 'ai.service.text.provider', 'deepseek', 'ai', '文本模型服务商', 1, NOW(), NOW()),
(23, 'ai.service.text.base-url', 'https://api.deepseek.com/v1', 'ai', '文本模型服务地址', 1, NOW(), NOW()),
(24, 'ai.service.text.api-key', 'sk-07e34e882e704e07ae1d33288036724d', 'ai', '文本模型服务密钥', 1, NOW(), NOW()),
(25, 'ai.service.text.model', 'deepseek-chat', 'ai', '文本模型 ID', 1, NOW(), NOW()),
(26, 'ai.service.image.provider', 'openai_compatible', 'ai', '图片模型服务商', 0, NOW(), NOW()),
(27, 'ai.service.image.base-url', 'https://api.example.com/v1', 'ai', '图片模型服务地址', 0, NOW(), NOW()),
(28, 'ai.service.image.api-key', 'replace-me', 'ai', '图片模型服务密钥', 0, NOW(), NOW()),
(29, 'ai.service.image.model', 'image-model', 'ai', '图片模型 ID', 0, NOW(), NOW()),
(30, 'ai.service.video.provider', 'openai_compatible', 'ai', '视频模型服务商', 0, NOW(), NOW()),
(31, 'ai.service.video.base-url', 'https://api.example.com/v1', 'ai', '视频模型服务地址', 0, NOW(), NOW()),
(32, 'ai.service.video.api-key', 'replace-me', 'ai', '视频模型服务密钥', 0, NOW(), NOW()),
(33, 'ai.service.video.model', 'video-model', 'ai', '视频模型 ID', 0, NOW(), NOW()),
(34, 'ai.service.audio.provider', 'openai_compatible', 'ai', '语音模型服务商', 0, NOW(), NOW()),
(35, 'ai.service.audio.base-url', 'https://api.example.com/v1', 'ai', '语音模型服务地址', 0, NOW(), NOW()),
(36, 'ai.service.audio.api-key', 'replace-me', 'ai', '语音模型服务密钥', 0, NOW(), NOW()),
(37, 'ai.service.audio.model', 'audio-model', 'ai', '语音模型 ID', 0, NOW(), NOW())
