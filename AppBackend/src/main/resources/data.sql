...
-- 餐厅 (类型1，状态1=正常/开放)
(1, '第一学生餐厅', 1, 1, '位于学校南门，主要提供快餐服务，菜品种类丰富，价格实惠。', '南门东侧100米', 114.899943, 40.755491, NULL, NULL, '["https://picsum.photos/800/600?random=1","https://picsum.photos/800/600?random=2"]', NOW(), NOW()),
(2, '第二学生餐厅', 1, 1, '位于学校中心区域，以地方特色菜为主，环境优雅。', '学校中心广场北侧', 114.900515, 40.756261, NULL, NULL, '["https://picsum.photos/800/600?random=3"]', NOW(), NOW()),
(3, '清真餐厅', 1, 1, '专门提供清真美食，食材新鲜，口味正宗。', '东门附近', 114.902015, 40.754761, NULL, NULL, '["https://picsum.photos/800/600?random=4"]', NOW(), NOW()),
-- 运动场 (类型2，状态: 1=正常 2=维护中 3=关闭)
(4, '东区运动场', 2, 1, '包含篮球场、足球场、羽毛球场等设施，是师生锻炼的首选之地。', '学校东区', 114.901015, 40.757261, NULL, NULL, '["https://picsum.photos/800/600?random=5"]', NOW(), NOW()),
(5, '体育馆', 2, 2, '室内体育馆，设有篮球场、羽毛球场、乒乓球室等。', '学校北门', 114.898515, 40.756761, NULL, NULL, '["https://picsum.photos/800/600?random=6"]', NOW(), NOW()),
(6, '田径场', 2, 1, '标准400米跑道，天然草坪足球场，适合跑步和足球运动。', '学校西侧', 114.897015, 40.755261, NULL, NULL, '["https://picsum.photos/800/600?random=7"]', NOW(), NOW()),
-- 教学楼 (类型3，状态: 1=正常 2=维护中 3=关闭)
(7, '博学楼', 3, 1, '学校主教学楼，设施齐全，教室宽敞明亮。', '学校中轴线', 114.900315, 40.755761, NULL, NULL, '["https://picsum.photos/800/600?random=8"]', NOW(), NOW()),
(8, '致远楼', 3, 3, '主要用于实验教学，配备先进实验设备。', '博学楼东侧', 114.900715, 40.755961, NULL, NULL, '["https://picsum.photos/800/600?random=9"]', NOW(), NOW()),
(9, '图书馆', 3, 1, '学校图书馆，藏书丰富，学习环境舒适。', '学校中心', 114.900115, 40.755561, NULL, NULL, '["https://picsum.photos/800/600?random=10"]', NOW(), NOW()),
-- 宿舍 (类型4)
(10, '松园1号楼', 4, 1, '男生宿舍楼，环境优美，设施完善。', '学校东区松园', 114.901515, 40.757761, NULL, NULL, '["https://picsum.photos/800/600?random=11"]', NOW(), NOW()),
(11, '松园2号楼', 4, 1, '男生宿舍楼，靠近食堂，生活便利。', '学校东区松园', 114.901715, 40.757561, NULL, NULL, '["https://picsum.photos/800/600?random=12"]', NOW(), NOW()),
(12, '竹园1号楼', 4, 1, '女生宿舍楼，安全安静，适合学习。', '学校北区竹园', 114.899015, 40.758261, NULL, NULL, '["https://picsum.photos/800/600?random=13"]', NOW(), NOW()),
(13, '竹园2号楼', 4, 1, '女生宿舍楼，距离图书馆近。', '学校北区竹园', 114.899215, 40.758061, NULL, NULL, '["https://picsum.photos/800/600?random=14"]', NOW(), NOW());
...
(1, 'map_center_longitude', '114.897014', '地图中心经度', NOW(), NOW()),
(2, 'map_center_latitude', '40.755502', '地图中心纬度', NOW(), NOW()),
...
(1, 4, 114.899943, 40.755491, 1, 150.50, 120, 2, NOW(), NOW()),
(2, 4, 114.899943, 40.755491, 7, 200.00, 180, 2, NOW(), NOW()),
(3, 5, 114.901515, 40.757761, 4, 300.00, 240, 2, NOW(), NOW()),
(4, 6, 114.899015, 40.758261, 9, 500.00, 400, 2, NOW(), NOW()),
(5, 7, 114.898515, 40.756761, 5, 100.00, 60, 1, NULL, NOW());
...
(1, 4, 1, '第一学生餐厅', 114.899943, 40.755491, 1, '常去吃饭', NOW()),
(2, 4, 7, '博学楼', 114.900315, 40.755761, 3, '上课地点', NOW()),
(3, 4, 9, '图书馆', 114.900115, 40.755561, 3, '自习', NOW()),
(4, 5, 2, '第二学生餐厅', 114.900515, 40.756261, 1, '喜欢吃粤菜', NOW()),
(5, 5, 4, '东区运动场', 114.901015, 40.757261, 2, '打篮球', NOW()),
(6, 6, 3, '清真餐厅', 114.902015, 40.754761, 1, '清真美食', NOW()),
(7, 6, 12, '竹园1号楼', 114.899015, 40.758261, 4, '宿舍', NOW()),
(8, 7, 6, '田径场', 114.897015, 40.755261, 2, '跑步', NOW()),
(9, 7, 10, '松园1号楼', 114.901515, 40.757761, 4, '宿舍', NOW());
-- =============================================
