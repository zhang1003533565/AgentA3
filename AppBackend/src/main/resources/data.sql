...
-- 8. 论坛帖子
-- =============================================
INSERT INTO forum_post (id, user_id, title, content, images, topic_id, is_anonymous, view_count, like_count, comment_count, status, create_time, update_time) VALUES
...
希望对大家有帮助！', NULL, 1, 0, 256, 45, 12, 'PUBLISHED', '2026-03-15 14:30:00', '2026-03-15 14:30:00'),
(2, 5, '寻找羽毛球搭子', '有没有喜欢打羽毛球的同学？周末一起打球呀！

时间：周六下午3点
地点：体育馆羽毛球场

有兴趣的同学评论区留言~', NULL, 2, 0, 128, 23, 8, 'PUBLISHED', '2026-03-15 10:20:00', '2026-03-15 10:20:00'),
...
有意向的同学私信我~', NULL, 3, 0, 89, 15, 5, 'PUBLISHED', '2026-03-14 16:45:00', '2026-03-14 16:45:00'),
...
老板说凭学生证打9折！', NULL, 4, 0, 512, 89, 34, 'PUBLISHED', '2026-03-14 12:00:00', '2026-03-14 12:00:00'),
...
加油！考研人！', NULL, 7, 0, 320, 67, 22, 'PUBLISHED', '2026-03-13 20:30:00', '2026-03-13 20:30:00'),
...
寻找：擅长数学建模和论文写作的同学', NULL, 1, 0, 156, 28, 10, 'PUBLISHED', '2026-03-12 15:00:00', '2026-03-12 15:00:00'),
...
大家还有其他推荐吗？', NULL, 2, 0, 98, 18, 6, 'PUBLISHED', '2026-03-11 18:20:00', '2026-03-11 18:20:00'),
(8, 6, '转让健身卡', '还有半年到期的健身房年卡转让，原价1200，现价600。

健身房位置：学校东门
设施齐全：器械区、有氧区、游泳池

需要的同学联系我！', NULL, 3, 0, 76, 12, 4, 'PUBLISHED', '2026-03-10 14:30:00', '2026-03-10 14:30:00');

-- =============================================
-- 9. 论坛评论
-- =============================================
INSERT INTO forum_comment (id, post_id, user_id, parent_id, reply_to_id, content, like_count, status, create_time) VALUES
-- 帖子1的评论
(1, 1, 5, NULL, NULL, '感谢分享！这些方法很实用，我已经开始尝试了。', 12, 'NORMAL', '2026-03-15 15:30:00'),
(2, 1, 7, NULL, NULL, '请问有没有高数的复习资料可以分享一下？', 5, 'NORMAL', '2026-03-15 16:00:00'),
(3, 1, 4, 2, 7, '有的，我稍后整理一下发到帖子里。', 8, 'NORMAL', '2026-03-15 16:15:00'),
-- 帖子2的评论
(4, 2, 7, NULL, NULL, '我也想打球！周末下午可以吗？', 3, 'NORMAL', '2026-03-15 11:00:00'),
(5, 2, 8, NULL, NULL, '算我一个！', 2, 'NORMAL', '2026-03-15 11:30:00'),
-- 帖子4的评论
(6, 4, 4, NULL, NULL, '这家确实好吃！强烈推荐他们的牛肉丸！', 15, 'NORMAL', '2026-03-14 12:30:00'),
(7, 4, 5, NULL, NULL, '中午刚去吃过，确实不错！', 8, 'NORMAL', '2026-03-14 13:00:00'),
(8, 4, 6, NULL, NULL, '求问营业时间？', 3, 'NORMAL', '2026-03-14 13:30:00'),
-- 帖子5的评论
(9, 5, 4, NULL, NULL, '学长分享得很详细，收藏了！', 10, 'NORMAL', '2026-03-13 21:00:00'),
(10, 5, 7, NULL, NULL, '请问用的什么单词书？', 4, 'NORMAL', '2026-03-13 21:30:00');