...
CREATE TABLE IF NOT EXISTS map_place (
    ...
    stall_status INT NULL COMMENT '档口营业状态: 1-营业中 2-休息中 3-已关闭',
    business_hours VARCHAR(100) NULL COMMENT '档口营业时间',
    avg_price DECIMAL(10,2) NULL COMMENT '档口人均价格',
    image_url VARCHAR(500) NULL COMMENT '档口图片',
