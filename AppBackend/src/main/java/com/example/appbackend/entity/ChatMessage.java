...
public class ChatMessage {
    ...
    @Column(nullable = false, columnDefinition = "INT NOT NULL DEFAULT 1 COMMENT '消息类型: 0-系统交易消息 1-文本 2-图片 3-位置 4-联系方式'")
    @Schema(description = "消息类型: 0-系统交易消息 1-文本 2-图片 3-位置 4-联系方式", example = "1")
