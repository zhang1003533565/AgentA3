...
class PythonProblemGeneratorAgent:
    name = "python_problem_generator_agent"
...
python_problem_generator_agent = PythonProblemGeneratorAgent()

__all__ = ["python_problem_generator_agent"]
