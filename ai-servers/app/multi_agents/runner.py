...
def run_specialist_agent(
    ...
    if normalized == "md_knowledge_agent":
        return md_knowledge_agent.extract_knowledge_points(input_text, evidence, chat_service=chat_service)
    ...
    if normalized == "textbook_question_bank_agent":
        return textbook_question_bank_agent.generate_questions(input_text, evidence, chat_service=chat_service)
