...
FILE_FORMAT_REGISTRY: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "canDetect": True,
        "canExport": True,
        "tool": "ai_ppt_generation_tool",
        "description": "PPT 演示文稿输入、链接识别和 AI 生成导出。",
    },
    {
        "key": "spreadsheet",
        "name": "Excel 表格",
        ...
        "canExport": False,
        "tool": "",
        "description": "Excel/CSV 表格输入和链接识别。",
    },
    {
        "key": "markdown",
        "name": "Markdown 文件",
