...
from app.services.ppt_template_selection import parse_ppt_page_count, parse_ppt_topic
...
def _derive_topic(input_text: str) -> str:
    return parse_ppt_topic(input_text)
...
def start_leader_ppt_generation(
    ...
    *,
    ...
    requested_pages = page_count if page_count is not None else parse_ppt_page_count(source_content, LEADER_PPT_DEFAULT_PAGE_COUNT)
